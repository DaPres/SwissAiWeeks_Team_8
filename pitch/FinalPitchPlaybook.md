...
| **44–54s** | **Human in the Loop: Review & One-Click Dispatch**<br>L2 Analyst reviews cited resolution proposal `[KB-14]`. Approves with one click; ticket is resolved and closed. | **Hybrid Grounding & ITSM Dispatch**<br>Apertus / Swiss LLM grounding verified. Dispatch webhook fires into Jira Service Management / ServiceNow. Audit trail logged. | “The analyst doesn't start from scratch. TriageMate drafts a cited resolution from proven playbooks, leaving the human in full control to review and approve with one click.” |
| **54–60s** | **Unified Architecture Badge & Big Finish**<br>Split screen converges into the unified architecture badge: **Intake Partner ➔ TriageMate Engine ➔ Human in the Loop**.<br>Final slide displays team8 solution impact: 40% deflection, 0s triage delay, 100% ITIL consistency. | **Full-Stack Compound AI Architecture**<br>End-to-end data pipeline glow: Requester ➔ Intake Micro-frontend ➔ Secure API ➔ TriageMate Core ➔ ITSM System (Jira / ServiceNow). | “Clearer requests for employees. Zero triage delay for support. AI proposes, people approve. Solving enterprise support at both ends.” |
