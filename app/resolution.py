...
RULES = [
    ...
    ("duplicate_of_open", "duplicate of an open ticket on the same service", Resolution.CANCELLED),
    ("spam", "spam / not a service request", Resolution.CANCELLED),
    ("unclear_or_missing_info", "unclear or missing information", Resolution.CLARIFICATION),
...
def decide(
    ...
    if flags.duplicate or flags.related_open:
